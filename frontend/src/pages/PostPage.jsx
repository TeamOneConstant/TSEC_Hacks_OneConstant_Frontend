...
export default function PostPage() {
  ...
  const handlePost = async (e) => {
    ...
    const { photo, text, platform } = formData;
    ...
    reader.onloadend = async () => {
      ...
      try {
        const response = await axios.post(
          "https://tsec-hacks.vercel.app/api/integrations/post",
          {
            photo: "E:/Download/MyDownloads/Cities-in-Japan.jpg",
            post_type: "image",
            text: "Hello all this is team OneConstant, from JAPAN",
            platform: "Facebook",
          }
        );
    ...
    <>
      <form onSubmit={handlePost}>
        <div className="text-left ml-[180px] h-full overflow-y-hidden">
          <p className="w-[180px] h-[60px] font-semibold text-2xl">
            Send a post
          </p>
          <p className="w-[750px] h-[60px] text-left text-lg text-[#5f5f5f] ">
            ...
            social media platforms and let your unique voice resonate far and
            wide
          </p>
